...
Для работы с LLamaSharp версии 0.25 в рамках проекта на .NET 9 требуются следующие пакеты. Они обеспечивают инференс моделей и бесшовную интеграцию с оркестратором ИИ:
